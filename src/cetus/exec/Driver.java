...
*/
    ...
    options.add("help",
                "Print this message");
/* will be replaced by a new pass
...
*/
  ...
  {
    System.err.println("Cetus 1.0 - A Source-to-Source Compiler for C");
  ...
  public void runPasses()
  {
    ...
    String[][] pass_prerequisites = { { "inline", "tsingle-call", "tsingle-return" },
                                      { "parallelize-loops", "privatize", "reduction", "ompGen" } };
