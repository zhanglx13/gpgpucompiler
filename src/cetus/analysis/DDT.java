...
public class DDT extends LoopAnalysisPass
{
  ...
  public void analyzeLoop(Loop loop)
  {
    ...
    */
    ...
    Tools.println("induction variables are: " + induction_variables.toString(), 2);
    ...
    for (ArrayAccess def : array_def_set)
    {
      ...
      for (ArrayAccess def2 : array_def_set)
      {
        ...
        {
          Tools.println("dependence found: " + def + " and " + def2, 2);
          markSerial(loop);
          return;
        }
      }
      ...
      for (ArrayAccess use : array_use_set)
      {
        ...
        {
          Tools.println("dependence found: " + def + " and " + use, 2);
          markSerial(loop);
          return;
        }
      }
    ...
    Tools.println("loop was parallel", 2);
...
*/
  ...
  {
    Tools.println("testing possible array dep: " + a1.toString() + ", " + a2.toString(), 2);
    ...
    Tools.println("subscript_pairs are " + subscript_pairs, 2);
    ...
    Tools.println("min_coupled_groups are " + min_coupled_groups, 2);
  ...
  private boolean testSIV(Vector<SubscriptPair> group, InductionVariable ivar)
  {
    ...
    for (SubscriptPair pair : group)
    {
      ...
      Tools.println("e1: " + Integer.toString(e1_coeff) + " * ivar + " + Integer.toString(e1_const), 2);
      Tools.println("e2: " + Integer.toString(e2_coeff) + " * ivar + " + Integer.toString(e2_const), 2);
