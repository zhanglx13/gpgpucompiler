...
public class DFANode
{
	...
	/**
	 * Returns the first data while searching for the specified array of keys.
	 *
	 * @param the array of keys.
...
*/
	 ...
	 * @return the data found first. null if the keys do not exist.
	 */
	public Object getData(List keys)
	{
		Object ret = null;

		for ( Object key : keys )
			if ( (ret = this.getData((String)key)) != null )
				return ret;
	 ...
	 */
	public Object getSuccData(DFANode key)
	{
		return succs.get(key);
	}
	 ...
	 * @return			the associated data for the key.
	 */
	public Object getPredData(DFANode key)
	{
