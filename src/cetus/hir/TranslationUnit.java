...
*/
  ...
  {
		if ( Driver.getOptionValue("print-with-string") == null )
    	print(new FileOutputStream(output_filename));
		else
    	printWithString(new FileOutputStream(output_filename));
  }


/**
 * Prints this translation unit to the output file using toString method.
 */
	public void printWithString(OutputStream stream)
	{
		PrintStream p = new PrintStream(stream);
		p.print(toString2());
	}
